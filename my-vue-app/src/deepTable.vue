<template>
  <div class="deep-table-container">
    <el-table :data="tableData" style="width: 100%" row-key="id" :expand-row-keys="expandedRowKeys"
      @expand-change="handleExpandChange">
      <el-table-column type="expand">
        <template #default="{ row }">
          <nested-table :data="row.nestedData || []" :loading="row.loading" />
        </template>
      </el-table-column>
    ...
    <el-dialog append-to-body v-model="dialogVisible" title="Tips" width="500" :before-close="handleClose">
...
// 定义数据类型import { ElMessageBox } from 'element-plus'
